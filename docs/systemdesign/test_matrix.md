...
|-------------------------------------|-----------------------------------------|-----------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `tests/unit` / `tests/domain`       | Domain and pure functions               | `lib_layered_config.domain.*`, `observability`                        | Validates immutability, provenance helpers, and logging utilities without hitting I/O boundaries.                                                                         |
