...
* CI (`.github/workflows/ci.yml`) matrix covering 3.13/3.14, Ruff linting, import-linter, Pyright, pytest with coverage, packaging smoke tests (pipx/uv, Conda, Nix), and notebook execution.
